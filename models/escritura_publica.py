...
class EscrituraPublicaRequest(DocumentRequest):
    """Modelo para requisição de análise de escritura pública"""
    pass

class EscrituraPublicaResponse(BaseModel):
    """Modelo para resposta da análise de escritura pública
